...
This program is to show the raw, compressed or theora image from RAPOSA camera with image_transport package.
...
queue<float> qu;           // value of queue to put FPS
...
int main(int argc, char **argv)
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////  	
  	//                                                                                            //
  	//   If you want to know about Transport Hints:                              	              //  
  	// " http://www.ros.org/wiki/roscpp/Overview/Publishers%20and%20Subscribers#Transport_Hints " //
  	//                                                                                            //
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cvNamedWindow("RAPOSA cam", 0);       // creates the window for camera image 
  	...
  	image_transport::ImageTransport it(nh);                                               // creates image_transport instance in nodehandle
  	  	
    image_transport::Subscriber image = it.subscribe("get/image", 1, imageCallback);      // subscribes image from republisher
