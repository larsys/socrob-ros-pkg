...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nh("~");    
		...
		nh.param("rectify", p.rectify, true);	 
		nh.param("normal",  p.normal, true);	
		nh.param("stereo",  p.stereo, true);			 		
		nh.param("flush",   p.flush,   true);	
		nh.param("dma",     p.dma,     8);	
    ...
    Bumblebee2_Show_Info(bumblebee);
		...
		if (p.rectify) {
			...
			rc_left_info.K[2] = rc_right_info.K[2] = crow;
			rc_left_info.K[5] = rc_right_info.K[5] = ccol;	
			rc_left_info.K[1] = rc_right_info.K[1] = 
			rc_left_info.K[3] = rc_right_info.K[3] = 
			rc_left_info.K[6] = rc_right_info.K[6] =
			rc_left_info.K[7] = rc_right_info.K[7] = 0.0;
			...
			rc_left.header.frame_id  = frame_id_left;
			rc_right.header.frame_id = frame_id_right;
		...
		bb_left.header.frame_id  = frame_id_left;
		bb_right.header.frame_id = frame_id_right;	
