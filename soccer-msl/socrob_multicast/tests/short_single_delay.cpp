...
{
  init (argc, argv, "short_single_delay");
  ...
  TestShortSingleDelay test_short (sid, "Normal");
  
  {
    Manager srmm (ManagerOptions (sid, 5, "239.255.1.1")
                  ...
                  .ports (2000, 2001)
                  .tup_ms (100)
                  .short_handler (boost::bind (&TestShortSingleDelay::short_handler, boost::ref (test_short), _1, _2, _3)));
