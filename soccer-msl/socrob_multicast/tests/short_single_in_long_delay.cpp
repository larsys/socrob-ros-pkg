...
{
  init (argc, argv, "short_single_in_long_delay");
  ...
  TestShortSingleInLongDelay test_short (sid, "Normal");
  
  {
    Manager srmm (ManagerOptions (sid, 5, "239.255.1.1")
                  ...
                  .ports (2000, 2001)
                  .tup_ms (100)
                  .long_marshall (boost::bind (&TestShortSingleInLongDelay::long_marshall, boost::ref (test_short), _1))
                  .long_unmarshall (boost::bind (&TestShortSingleInLongDelay::long_unmarshall, boost::ref (test_short), _1, _2)));
