...
/*void poseCallback(geometry_msgs::PoseWithCovarianceStamped const &pose_g) {

	x_glo=pose_g.pose.pose.position.x;
	y_glo=pose_g.pose.pose.position.y;
}*/
...
/*	// Stabilized transform (z, yaw)
  ...
  */
	...
	transform.child_frame_id_ = footprint_frame_id;
	transform.stamp_ = imu.header.stamp;
...
int main(int argc, char** argv) {
	...
	//sub2 = nh.subscribe("/poseupdate", 10, poseCallback);
