...
class KeyframeGraphDetector
{
  public:
    ...
    const std::vector<std::vector<aruco::Marker> > getMarkers() const { return found_markers; }
    ...
    void generateKeyframeAssociations_Iterative(
      KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    ...
    void buildMatchMatrixSurfTree_Iterative(unsigned int kf_idx,
      const KeyframeVector& keyframes);
    void buildAssociationMatrix(
      const KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    void buildAssociationMatrix_Iterative(
      const KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    ...
    // Aruco
    float marker_size; //length of the side in meters
    ...
    void buildCorrespondenceMatrix(
      const KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    void buildCorrespondenceMatrix_mine(
      const KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    void buildCorrespondenceMatrix_onlyLandmarks(
      const KeyframeVector& keyframes,
      KeyframeAssociationVector& associations);
    void buildCorrespondenceMatrix_mine_Iterative(u_int kf_idx_q,
                                                  const KeyframeVector& keyframes,
                                                  KeyframeAssociationVector& associations);
    void buildCorrespondenceMatrix_rgb_Iterative(u_int kf_idx_q,
                                                 const KeyframeVector& keyframes,
                                                 KeyframeAssociationVector& associations);
