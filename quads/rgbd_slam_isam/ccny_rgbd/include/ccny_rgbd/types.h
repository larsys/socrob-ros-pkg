...
typedef message_filters::sync_policies::ApproximateTime<ImageMsg, CameraInfoMsg> RGBSyncPolicy;
...
typedef message_filters::Synchronizer<RGBSyncPolicy> RGBSynchronizer;
