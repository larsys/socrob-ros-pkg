...
class RGBNavigator
{
  public:
     ...
     */  
    RGBNavigator(const ros::NodeHandle& nh,
                   const ros::NodeHandle& nh_private);
    
    /** @brief Default destructor
     */
    virtual ~RGBNavigator();
  ...
  protected:
     ...
     */
    virtual void RGBCallback(const ImageMsg::ConstPtr& rgb_msg,
  ...
  private:
    ...
    boost::shared_ptr<RGBSynchronizer> sync_;
    ...
    double min_map_z_;   ///< min z (in fixed frame) when exporting maps.
