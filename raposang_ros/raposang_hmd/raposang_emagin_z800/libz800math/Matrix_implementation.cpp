...
static bool equivalent(double a, double b, double e = 0.000001)
{
	return abs(a - b) < e;
}
...
void Matrix_implementation::getLookAt(Vec3f& eye,Vec3f& center,Vec3f& up,value_type lookDistance) const
{
    ...
    inv.invert(*this);
    eye = Vec3f(0.0,0.0,0.0)*inv;
    up = transform3x3(*this,Vec3f(0.0,1.0,0.0));
    center = transform3x3(*this,Vec3f(0.0,0.0,-1));
    center.normalize();
...
void Matrix_implementation::getLookAt(Vec3d& eye,Vec3d& center,Vec3d& up,value_type lookDistance) const
{
    Matrix_implementation inv;
    inv.invert(*this);
    eye = Vec3d(0.0,0.0,0.0)*inv;
    up = transform3x3(*this,Vec3d(0.0,1.0,0.0));
    center = transform3x3(*this,Vec3d(0.0,0.0,-1));
    center.normalize();
    center = eye + center*lookDistance;
}
