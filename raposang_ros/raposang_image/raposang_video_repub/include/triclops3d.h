...
//=============================================================================
//=============================================================================
// $Id: triclops3d.h,v 2.1 2004/04/20 22:05:17 donm Exp $
//=============================================================================
#ifndef TRICLOPS3D_H
#define TRICLOPS3D_H
...
//  mapping feature.  If you do not have the disparity mapping values set to 
...
// Note: Disparity offset SHOULD NOT be applied to input disp values. In this 
...
//  XYZ coordinates.
//
// Note: It is up to the user to supply valid pixel locations.  Pixels which 
//       have been invalidated may give negative results.
//
// Note: Disparity offset MUST be applied to input disp values, if offset != 0,
...
//  triclopsRCD16ToWorldXYZ(), triclopsSetTriclopsToWorldTransform(), triclopsGetTriclopsToWorldTransform()
//  triclopsGetDisparityOffset()
//
TriclopsError
...
//  disparity  mapping feature.  If you have set "Disparity Mapping" on
//  you should use this function.  However, it is less efficient than the 
//  other XYZ conversion functions and may have some round-off errors.  
//  It is preferable to set the disparity mapping off.
//  This function will transform the point into a "world" coordinate system
//  based on the transform recorded in the TriclopsContext.
//
// Note: It is up to the user to supply valid disparity values, invalid
...
//  provided transform.  There are several things to note:
//  - the transform is the Triclops-to-World transform.  ie: when this
//    transform is applied to a Triclops point, it will change it to a world
//    point
//  - the transform must be of the approved format.  This means it has a 3x3
